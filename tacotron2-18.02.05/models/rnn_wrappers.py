...
from .modules import dec_prenet, projection
import Config as cf
...
class TacotronDecoderWrapper(RNNCell):
  ...
  def call(self, inputs, state):
    ...
    prenet_outputs = dec_prenet(inputs, cf.dec_prenet_size, scope='decoder_prenet_layer')
    ...
    #Linear projection
    cell_output = (projection(concat_output_LSTM, cf.num_mels, scope='decoder_projection_layer'), LSTM_output)
