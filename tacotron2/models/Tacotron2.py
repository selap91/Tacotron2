...
from .modules import *
from .wrappers import TacotronDecoderWrapper
from .dynamic_decoder import dynamic_decode
from .custom_decoder import CustomDecoder
from .attention_wrapper import AttentionWrapper, LocationSensitiveAttention
...
class Tacotron2():
    ...
    def initialize(
        ...
        with tf.variable_scope('inference'):
            ...
            attention_wrapped_cell = AttentionWrapper(prenet_wrapped_cell,
                                                      LocationSensitiveAttention(hp.attention_size, encoder_outputs),
            ...
            if is_training:
                ...
                helper = TacoTestHelper(batch_size, hp.num_mels, 1)
