...
def enc_bi_LSTM(inputs, input_lengths, is_training, scope=None):
    ...
    with tf.variable_scope(scope or 'enc_bi_LSTM'):
        cell_fw = ZoneoutLSTMCell(hp.enc_rnn_size//2, is_training, zoneout_factor_cell=hp.zoneout_prob, zoneout_factor_output=hp.zoneout_prob)
        cell_bw = ZoneoutLSTMCell(hp.enc_rnn_size//2, is_training, zoneout_factor_cell=hp.zoneout_prob, zoneout_factor_output=hp.zoneout_prob)
